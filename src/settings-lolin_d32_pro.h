...
#define __ESPUINO_SETTINGS_LOLIN_D32_PRO_H__
    ...
    */
    ...
    // Rotary encoder
        ...
        #define ROTARYENCODER_CLK           32          // If you want to reverse encoder's direction, just switch GPIOs of CLK with DT (in software or hardware)
    ...
    #ifdef MEASURE_BATTERY_VOLTAGE
        constexpr uint8_t rdiv1 = 116;                            // Cannot be changed, it's built in
